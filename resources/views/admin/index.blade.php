...
@section('content')
    ...
    <head>
        ...
        <meta name="description"
            content="Informasi data terbaru mengenai kasus Virus Corona di seluruh dunia. Data di website kawalcorona.com akan selalu di update secara otomatis dan berasal dari Johns Hopkins University">
                    ...
                    <div class="">
                        ...
                        <div class="row">
                                ...
                                <div class="card bg-danger img-card box-primary-shadow">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            ...
                                            <div class="ml-auto"> <img src="../uploads/sad-u6e.png" width="50" height="50"
                                                    alt="Positif"> </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card bg-success img-card box-secondary-shadow">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            ...
                                            <div class="ml-auto"> <img src="../uploads/happy-ipM.png" width="50" height="50"
                                                    alt="Positif"> </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card  bg-secondary img-card box-success-shadow">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            ...
                                            <div class="ml-auto"> <img src="../uploads/emoji-LWx.png" width="50" height="50"
                                                    alt="Positif"> </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="text-white">
                                                ...
                                                <p class="text-white mb-0"><b>1,174,779</b> POSITIF, <b>973,452</b> SEMBUH,
                                                    <b>31,976</b> MENINGGAL</p>
                                            </div>

                                            <div class="ml-auto"> <img src="../uploads/indonesia-PZq.png" width="50"
                            ...
                            <div class="col text-center">
                                <p>Update terakhir : 10 Februari 2021 09:11:09 WIB</p>
                            </div>
                        </div>
                        <!-- ROW-1 CLOSED -->
                                        ...
                                        <div class="row mt-6">
                                            <div class="col text-center">
                                                ...
                                                <p class="mb-0 text-muted"><span
                                                        class="text-lg font-weight-700"></span>ORANG</p>
                            ...
                            <div class="col-md-12 col-xl-6">
                                <a href="https://www.unicef.org/indonesia/id/coronavirus">
                                    <div class="card text-white bg-orange">
                                        <div class="card-body">
                                            <h4 class="card-title">Novel coronavirus (COVID-19): Hal-hal yang perlu Anda
                                                ketahui</h4>
                            ...
                            <div class="col-md-12 col-xl-6">
                                <a
                                    ...
                                    <div class="card text-white bg-secondary">
                                        <div class="card-body">
                                            <h4 class="card-title">Daftar 100 Rumah Sakit Rujukan Penanganan Virus Corona
                                            </h4>
                ...
                <footer>
                    <div class="footer border-top-0 footer-1">
                        ...
                        <div class="col-lg-12 col-sm-12 mt-3 mt-lg-0 text-center">
                            <br><a href="https://hack.co.id/"><img src="../uploads/logo-ehi.png"
                                    alt="Ethical Hacker Indonesia" width="172" height="45"></a><br><br>
                            Powered by <a href="https://hack.co.id/" target="_blank">Ethical Hacker Indonesia</a>. Made with
                            <i class="fa fa-heart"></i> by <a href="https://teguh.co" target="_blank">Teguh Aprianto</a>
                        </div>
                    </div>
            </div>
        </div>
