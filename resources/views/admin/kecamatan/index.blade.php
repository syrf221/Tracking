...
<div class="row">
	<div class="col-md-12 col-md-offset-2">
        <h3>{{$title}}</h3>
        <a href="{{route('kecamatan.create')}}" class="btn btn-primary float-right btn-sm"><i class="fas fa-plus-circle"></i> Tambah Data</a>
        <div class="box">
			<div class="box-body">
				...
				<table class="table table-kecamatan table-stripped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$no++}}</td>
                            <td style='text-align:center;vertical-align:middle'>{{$data->kode_kecamatan}}</td>
                            <td style='text-align:center;vertical-align:middle'>{{$data->nama_kecamatan}}</td>
